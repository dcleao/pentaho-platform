...
/**
 * The {@code AndAuthorizationRulesManager} class is an authorization rules manager which combines the results of a list
 ...
 */
public class AndAuthorizationRulesManager extends AbstractAuthorizationRulesManager {

  public AndAuthorizationRulesManager( @NonNull List<IAuthorizationRule> rules ) {
    super( rules );
  }
  ...
  public AuthorizationEvaluationResult evaluate( @NonNull AuthorizationEvaluationRequest request,
    ...
    // Grant by default.
    AuthorizationEvaluationResult combinedResult = AuthorizationEvaluationResult.grant();
  ...
  protected AuthorizationEvaluationResult combineResults(
    ...
    // Denied wins over granted, given this is an And manager.
    return accumulatedResult.isDenied() ? accumulatedResult : ruleResult;
  }
}
